...
1. Download `StartFlow-v0.0.0-win-x64.zip` and extract it to a permanent directory on your computer (e.g., D:\Programs\StartFlow).

2. Open the folder, locate and double-click StartFlow.exe to run the application.
